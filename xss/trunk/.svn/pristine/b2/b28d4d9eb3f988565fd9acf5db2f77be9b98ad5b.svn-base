...
public class ApiWorkMachineController {
    ...
    public List<AdActiveTaskLog> getAdActiveTasks(String mac, int count) {
        ...
        {
            WorkMachine newWorkMachine = workMachineService.getById(workMachine.getId());
            newWorkMachine.setLastConnectTime(now);
            workMachineService.saveItem(newWorkMachine);
        }
